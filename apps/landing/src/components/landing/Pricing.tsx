...
const plans = [
  {
    ...
    features: ["Até 3 usuários", "Gestão básica de até 3 projetos", "Geração de planos por IA", "Exportação para Excel"],
    cta: "Começar Grátis",
    highlighted: false,
  },
  {
    ...
    features: ["Até 10 usuários", "Tudo do Starter", "Gestão básica de até 10 projetos","Follow-up automático", "Disparo Automático de E-mails", "Integrações (Slack, e-mail, calendário)", "Relatórios avançados", "Suporte prioritário"],
